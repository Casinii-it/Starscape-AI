...
1. Press N, note the planet you are arriving at and the planet farthest from it
2. Press down CTRL
3. Long click on the probe icon until it launches
4. Release CTRL
5. Warp to the farthest planet using the Quick Warp Menu (SPACE)
...
* Before you sell/buy items, you should try to review the existing prices offered for that item and compare it to your price. Additionally you may want to ask experienced players for the item’s worth before trying to engage in a sale so that you can maximize profit and value from sales. For example, selling items at higher prices to get more credits and buying items at cheaper prices to spend less credits.
