...
![](./File:2021-01-31_12_13_30-Window.png)
...
The CM anomaly is an uncommon anomaly that can be found in all security classes except for Core and Uncharted. It contains a large comet, with an asteroid field trailing behind in the tail. Approximately half of the rocks are unminable Barren Fragments, while the other half contain Water Ice Cores.
...
The *AA Anomaly* is quite uncommon, and contains only Regular and Pristine Axnit, along with regular Korrelite. It can only be found in Contested, Unsecure and Wild systems, and is usually about the size of an AT anomaly field or smaller.

### AN Anomaly

![](./File:KorreliteAN.png)

Korrelite in an AN anomaly

AN Anomalies are rare anomalies that can only be found in wild systems. They are small fields of Narcor and Red Narcor Ore, though other ores such as Korrelite can also be found here less commonly. These fields of rare materials were previously the rarest Anomaly in the game, now tied only with the legendary VX anomaly. If you find one, mine all the Red Narcor first, as it is significantly more valuable.

![](./File:RobloxScreenShot20200905_192657933.png)
