Advanced Combat Interpretations
...
* Echelon can be used as as a tank in fleets dealing moderate damage, its similar to the bulwark, but has lower DPS and hull points in exchange for having the highest armor rating in the game, making it an amazing PVE ship against NPC fleets.
* Bulwark is a slow, powerful hull tank. It is widely considered one of the best PvE ships in the game, best suited for destroying NPC structures. It has 3 M-turrets, 3 S-turrets, and 2 PDTs.
...
Spinal Hardpoints "Fixed Hardpoints (F)")
...
* Kiting (going out of range of enemy ships while sniping them with beam or railgun turrets).
...
**NOTE:** In Contested+ systems (Contested, Unsecure, and Wild) your ship WILL remain in space for 60 seconds if you leave the game without safe-logging. During this period your ship is vulnerable to player damage. However, NPC's will not attack your ship. It is highly recommended to safe-log.
