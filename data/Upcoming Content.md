...
As of May 2025, Keth is working on The Conquered Frontier update, the first major update to the game in three years since the Next Gen update. The update consists of new Syndicate Haulers, Destroyer-Haulers, Player Structures, Region-based Resource Modifier and small features such as unique faction permissions and roles, asteroid texture overhauls, and others.

Currently, the planned release date of the update is August 2nd, 2025.

## Roadmap

This roadmap was announced in January 2024 when Keth returned. Keth has stated that this map is highly subject to change.

![](./File:Roadmap2024feb.png)
...
\*As of December 2024, probes have been changed back to items. Combat probes have yet to come out.
...
**Make The Tutorial A Little Better**
...
The original concept for player stations was very similar to Solo Stations but there would be less modular expansion. They would have their own storage system, unconnected to CoreSec Storage. Their invulnerability shields would be powered by Fuel, but it would have been made from heavy water, which would have replaced standard water when you refine Ice. When the station's fuel runs out, the shield goes down, and the station would become vulnerable to other players and would eventually be destroyed on its own.

### Solo Stations

![](./File:Starscape_player_station.png)
...
![](./File:New_Modules.png)

Faction Station modules

### Player Faction Stations

Faction stations would have been somewhat similar to what we have today. they would have had some sort of module customization. Bases would still require fuel to maintain its functions. The amount needed will increase depending on the size of the station and the modules it has. There would have been trading mechanics between faction stations.

### Planetary Landings

![](./File:Unknown.png)

ZolarKeth worked on them early in the game's development, but because of the massive load-in times and general lack of optimization of Roblox servers, they were discontinued until further notice. Planetary landings would use the same system that rings have currently, where players would be able to find specific points of interests that they would be able to lightburn to[[1]](./Upcoming_Content#cite_note-1). These POIs would be around 10k x 10k in size for players to roam around in[[2]](./Upcoming_Content#cite_note-2).

![](./File:NewPlanetLandings.png)
